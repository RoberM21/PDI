...
class EquipmentControllerTest < ActionController::TestCase
  ...
  test "should create equipment" do
    assert_difference('Equipment.count') do
      post :create, equipment: { entrada: @equipment.entrada, garantia: @equipment.garantia, marca: @equipment.marca, tipo: @equipment.tipo }
    end
  ...
  test "should update equipment" do
    patch :update, id: @equipment, equipment: { entrada: @equipment.entrada, garantia: @equipment.garantia, marca: @equipment.marca, tipo: @equipment.tipo }
    assert_redirected_to equipment_path(assigns(:equipment))
  end
